  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className={`flex items-center justify-center transition-all duration-200 cursor-pointer rounded-sm outline-none focus:ring-2 focus:ring-black focus:ring-inset ${
          variant === 'desktop'
      ...
      >
        {trigger ? trigger : <ProfileIcon size={20} aria-hidden="true" />}
      </button>
        ...
        >
          ...
          <div className="py-1" role="none">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-black/60 hover:bg-black/5 hover:text-black transition-colors text-left outline-none focus:bg-black/5 focus:text-black"
            >
              <ProfileIcon size={14} className="opacity-50" aria-hidden="true" />
              My Profile
            </button>
          </div>

          <div className="border-t border-black/5 py-1" role="none">
            <button
              role="menuitem"
              onClick={handleOpenLogoutModal}
              className="w-full flex items-center px-4 py-3 text-[11px] font-bold uppercase tracking-[0.2em] text-red-500 hover:bg-red-50 transition-colors text-left outline-none focus:bg-red-50 focus:text-red-600"
            >
              Logout
            </button>
          </div>
